...
\providecommand{\SRFaultLocalized}{24/24}
\providecommand{\SRFaultClasses}{8}
\providecommand{\SRFaultRelationTypes}{3}
\providecommand{\SRArmDeliveredLadder}{10\,$\to$\,8\,$\to$\,8\,$\to$\,8\,$\to$\,0}
\providecommand{\SRArmGroundedLadder}{10\,$\to$\,8\,$\to$\,8\,$\to$\,8\,$\to$\,3\,$\to$\,2}
\providecommand{\SRArmStoredLadder}{10\,$\to$\,7}
\providecommand{\SRArmDirectLadder}{10\,$\to$\,7}
\providecommand{\SRReplicaAnswerCorrect}{4}
\providecommand{\SRReplicaAnswerWrong}{20}
\providecommand{\SRReplicaAnswerAbstain}{4}
\providecommand{\SRReplicaEmptyCorrect}{27}
\providecommand{\SRReplicaEmptyWrong}{1}
\providecommand{\SRReplicaTrueAnswer}{4}
\providecommand{\SRReplicaTrueEmpty}{27}
\providecommand{\SRReplicaMiss}{22}
\providecommand{\SRReplicaFalseAnswer}{3}
\providecommand{\SRReplicaTotal}{56}
\providecommand{\SRReplicaSceneNs}{13/14/16/13}
\providecommand{\SRReplicaPooled}{31/56}
%% END TEMP-FALLBACK
...
\title{StageReach3D: Scope-Aware Fault Localization for\\
3D Scene-Graph Question Answering}
