...
of the authors marked two ambiguous \rid{F65}. Five arms answer the same questions over
the same stored relations, differing only in where identity comes from (\cref{tab:arms}).
...
consumes human identity, it sizes a bound --- it says the arms differ, not that anything deployable achieves 7/10.
