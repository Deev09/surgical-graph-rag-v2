...
\paragraph{Serialization adds no measurable loss.}
...
not answer, none the other way \rid{G06}. \Cref{fig:qualitative} shows one such question in the room itself. Because one side
...
\begin{figure*}[t]
  ...
  the basket and the desk is present and correct (surface distance $0.0$\,m against a
  $1.0$\,m threshold). A human resolving both referents answers it; the delivered labels
