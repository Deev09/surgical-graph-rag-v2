...
substitution sizing a bound, not a system improvement \rid{G06}. Relation extraction is
not the loss: a replay reading only serialized edges agrees with geometry recomputed
under the same convention on 12 of 12 items \rid{F63}. The information is present in the
