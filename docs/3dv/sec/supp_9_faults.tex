...
spurious failures on clean artifacts. The injectors and the per-stage
checkers share the evaluator's stage ontology: this validates the internal
consistency of the attribution machinery, not the localization of natural
faults arising in unfamiliar pipelines.
